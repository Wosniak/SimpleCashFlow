...
{
    public class MovementUpdatedHandlerTests
    {
        ...
        public MovementUpdatedHandlerTests()
        {
        ...
        public async Task Handle_Shoul_Run()
        {
            ...
            var notification = new MovementUpdatedDomainEvent(Guid.NewGuid(), new MovementId(Guid.NewGuid()));

            var handler = new MovementUpdatedEventHandler(_summaryRepository.Object, _unitOfWork.Object, _calculateCashFlowService.Object, _movementRepository.Object);
